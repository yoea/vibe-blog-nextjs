...
import type { ActionResult, Notification, NotificationType } from '@/lib/db/types'
...
export async function getNotifications(page: number): Promise<ActionResult & { data?: Notification[]; total?: number }> {
